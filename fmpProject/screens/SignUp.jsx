        ...
        <View style={{ flex: 1, marginVertical: 20 }}>
            <ScrollView>
                ...
                <View style={{ gap: 20 }}>
                    ...
                    <TextInput onChangeText={text => onChange_Hanlde("email", text)} keyboardType='email-address' onBlur={() => setBlur(true)} onFocus={() => setFocus(true)} style={customStyle} placeholder='Enter Your password' />
